# setup-base-bspwm
A workflow which automates the setup of a distribution hacking environment for Ubuntu/Debian using the tiled window manager [bspwm](https://github.com/baskerville/bspwm).
...
```shell
git clone https://github.com/MGSousa/setup-base-bspwm.git
cd setup-base-bspwm
```
...
- **Terminals**: [kitty](https://sw.kovidgoyal.net/kitty/) and [alacritty](https://github.com/alacritty/alacritty)
